...
const items = [
	{
		...
		popoverBackgroundColor: '#ffd3b0',
		popoverSide: 'left' as const,
		popoverVertical: 'bottom' as const,
	},
	{
		color: '#d20000',
		label: 'mercado',
		...
		popoverBackgroundColor: '#d20000',
		popoverSide: 'left' as const,
		popoverVertical: 'bottom' as const,
		popoverTextColor: 'white' as const,
	},
	{
		color: '#296196',
		label: 'fuentes',
