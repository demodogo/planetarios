			...
			<Disclosure>
				{({ open }) => (
					<>
						...
						<DisclosureButton
							className={`${open ? '' : 'hidden'} flex w-full items-center justify-end gap-2 rounded-lg px-1 py-2 transform-gpu hover:scale-120 transition-transform duration-200 cursor-pointer text-left font-bold text-black ${titleSide === 'left' ? 'justify-start' : 'justify-end origin-right'}`}
						>
